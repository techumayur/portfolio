               ...
               <div class="col-12">
                    <nav aria-label="breadcrumb">
                         <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Portfolio Inner</li>
                         </ol>
                    </nav>
               </div>
          </div>
...
<!-- 2.Portfolio  Content  Section Start Here -->
               ...
               <div class="col-12 portfolio-inner-wrapper">
                    <div class="portfolio-inner-author" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1700">
                         <ul class="list-unstyled">
                              <li>
                                   <img src="assets/images/blog/avatar.png" class="img-fluid" alt="Author">
                                   Author
                              </li>
                              <li>
...
<!-- 2.Portfolio  Content Section End Here -->
...
<!-- 4.Recent Portfolio Section Start Here -->
...
<!-- 4.Recent Portfolio Section End Here -->
