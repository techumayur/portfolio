...
<section class="wordpress-banner banner" style="background:url('assets/images/common/cta-bg.png');">
     <div class="container">
          <div class="row">
               ...
               <div class="col-12">
                    <nav aria-label="breadcrumb">
                         <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="index.Wordpress">Home</a></li>
          ...
          <div class="row">
               <div class="col-12 text-center" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="2500">
                    ...
                    <h2 class="title title-center">
                         The work that I did in Wordpress
                    </h2>
               </div>
               <div class="col-12 portfolio-content">
                    <!-- All Portfolio -->
                    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-5  justify-content-center item-list">
     ...
     <div class="container">
          <div class="row">
               ...
               <div class="col-lg-4 align-self-center pt-4 pt-lg-0" data-aos="fade-left" data-aos-easing="linear" data-aos-duration="2500">
                    <a href="source-code.Wordpress" class="main-btn cta-btn">
                         Get Here
                    </a>
               </div>
          </div>
