...
<script defer rel="text/javascript" src="assets/bootstrap/bootstrap.bundle.min.js"></script>
<!--  Fancybox Js File Link Here -->
<script defer rel="text/javascript" src="assets/fancybox/fancybox.js"></script>
<!-- Fontawesome Js File Link Here -->
<script defer rel="text/javascript" src="assets/font-awesome/all.min.js"></script>
